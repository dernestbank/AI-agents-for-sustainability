...
APP_NAME = "AI Agents for Sustainability (A4S)"
APP_VERSION = "0.1.0"
APP_DESCRIPTION = "A carbon accounting + ESG assistant that helps SMEs measure, report, and reduce emissions using agentic AI."
APP_AUTHOR = "ProcEm Engine Team 2025"
APP_CONTACT = ""
