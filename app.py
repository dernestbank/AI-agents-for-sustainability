...
st.set_page_config(page_title="A4S", page_icon="🌍", layout="wide")
...
translations = {
    'English': {
        ...
        'welcome_message': 'Welcome to AI Agents for Sustainability(A4S)! Start by adding your emissions data or uploading a CSV file.',
...
with st.sidebar:
    ...
    # Language selector
    language = st.selectbox(t('language'), ['English'])
    ...
    # Footer
    st.markdown(
        "<div class='footer' style='color: #555555;'> 2025 A4S<br>Product Owner: ProcEm Eng Team</div>",
        unsafe_allow_html=True
    )
